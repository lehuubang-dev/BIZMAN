...
export default function BrandCreate({ visible, onClose, onSuccess }: BrandCreateProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Lỗi', error?.message || 'Không thể tạo thương hiệu');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Tạo thương hiệu mới</Text>

...
export default function GroupCreate({ visible, onClose, onSuccess }: GroupCreateProps) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await productService.createGroup({
      ...
      Alert.alert('Lỗi', error?.message || 'Không thể tạo nhóm hàng hóa');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Tạo nhóm hàng hóa mới</Text>
          ...
          <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                style={styles.input}
                placeholder="Nhập loại công việc (VD: Văn phòng)"
                value={jobType}
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                style={styles.input}
                placeholder="Nhập thuế GTGT (VD: 0.1)"
                value={gtgttax}
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                style={styles.input}
                placeholder="Nhập thuế TNCN (VD: 0.3)"
                value={tncnntax}

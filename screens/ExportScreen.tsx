...
export default function ExportScreen() {
  ...
  const [exportDate, setExportDate] = useState(new Date().toLocaleDateString('vi-VN'));
  ...
  const calculateTotal = () => {
    return exportItems.reduce((sum, item) => {
    ...
    Alert.alert(
      ...
      [
        { text: 'Hủy', style: 'cancel' },
        {
          text: 'Xác nhận',
          onPress: () => {
            Alert.alert('Thành công', 'Đã tạo phiếu xuất kho thành công!');
            // Reset form
            setCustomer('');
            setOrderNumber('');
            setNote('');
    ...
    <View style={styles.container}>
      ...
      >
            ...
            <View style={[styles.inputGroup, styles.flex1, { marginLeft: 10 }]}>
              ...
              <View style={styles.inputWrapper}>
                <Ionicons 
                  ...
                  style={styles.inputIcon} 
                />
                <Text style={styles.dateText}>{exportDate}</Text>
              </View>
            </View>
          </View>
        ...
        >
          ...
          <Text style={styles.submitButtonText}>Tạo phiếu xuất kho</Text>
        </TouchableOpacity>
      </ScrollView>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Chọn sản phẩm xuất kho</Text>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.inputGroup}>
                <Text style={styles.label}>
                  Số lượng xuất <Text style={styles.required}>*</Text>
                </Text>
                <View style={styles.inputWrapper}>
